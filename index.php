...
<head>
  ...
  <script src="./own/js/main.js" defer></script>
</head>
...
<body class="hold-transition sidebar-mini sidebar-collapse ">
  <div class="wrapper">
          ...
          <div class="card">
            <div class="card-header ui-sortable-handle" style="cursor: move;">
              ...
              <div class="card-tools">
                <button id="addSoldProductBtn" type="button" class="btn btn-success btn-sm">
            ...
            <div class="card-body">
              ...
              <table id='mainDataTable' class="table table-bordered table-hover dataTable dtr-inline">
    ...
    <div class="modal fade" id="modal-addSold">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Eladás felvétele</h4>
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Count</label>
              <input id="countInput" type="text" class="form-control" placeholder="Enter ...">
            </div>

            <div class="form-group">
              <label>Unit price</label>
              <input id="priceInput" type="text" class="form-control" placeholder="Enter ...">
            </div>

            <div class="form-group">
              <label>Deposite</label>
              <input id="depositeInput" type="text" class="form-control" placeholder="Enter ...">
            </div>

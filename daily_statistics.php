...
<head>
  ...
  <script src="./own/js/daily_statistics.js" defer></script>
</head>
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="col-md-4">
              ...
              <div class="card">
                ...
                <div class="form-group">
                        ...
                        <textarea id="addByStringTextarea" class="form-control" rows="3" placeholder="Enter ..." style='resize: none;'></textarea>
                </div>
            ...
            <div class="col-md-4">
              ...
              <div class="card">
                <div class="card-header ui-sortable-handle" style="cursor: move;">
                  <h3 class="card-title">
                    <span id="chartTitle-1">Placeholder...</span>
                  </h3>
                  <div class="card-tools">
            ...
            <div class="col-md-4">
              ...
              <div class="card">
                <div class="card-header ui-sortable-handle" style="cursor: move;">
                  <h3 class="card-title">                  
                    <span id="chartTitle-2">Placeholder...</span>
                  </h3>
                  <div class="card-tools">
          ...
          <div id="chartDivRowCardContainer">
